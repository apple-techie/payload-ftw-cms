...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_blog_posts_category" AS ENUM('wellness', 'education', 'self-care', 'massage-therapy', 'athletic-recovery');
  CREATE TYPE "public"."enum_blog_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_services_category" AS ENUM('modern_massage', 'holistic_bodywork', 'athletic_recovery');
